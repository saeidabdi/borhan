        ...
        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" style="margin-top: 30px;">
            <div v-if="!goto_class">
                ...
                <div class="col-md-3 right" style="padding-top: 10px;">
                    <div class="form-group">
                        ...
                        <select class="form-control" v-model="lesson_id" @change="change_lesson()">
                ...
                <div class="col-md-3 right" style="padding-top: 10px;">
                    <div class="form-group">
                        <label class="label cat_lable">دبیر</label>
                        <select class="form-control" v-model="teacher_id">
                            <option v-for="teacher in all_teacher" :value="teacher.id">@{{teacher.name}}</option>
                        </select>
                    </div>
                </div>
            ...
            <div v-if="goto_class">
                <table v-if="all_special_film.length" class="table table-striped table-bordered table-hover table-condensed">
                    ...
                    <tbody>
                        <tr v-for="special in all_special_film" v-if="special.b_id == branch_id">
                            <td>@{{special.id}}</td>
